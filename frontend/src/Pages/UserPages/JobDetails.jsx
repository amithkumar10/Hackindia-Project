...
const JobDetails = () => {
  ...
  if (!job) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-base-300">
        <div className="text-xl mb-4 text-base-content">Job details not found. Please return to the job search page.</div>
        <button
  ...
  const handleApply = () => {
    ...
    setIsApplied(true);
    // You could add logic here to post the application data
  };
  ...
  return (
    <div data-theme="black" className="min-h-screen bg-base-300">
      ...
      <div className="container mx-auto px-4 py-4 max-w-4xl">
        ...
        <h1 className="text-3xl font-bold mb-4 text-base-content px-1 text-center">Job Details</h1>
          ...
          <div className="card-body p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
              <div className="border border-base-300 rounded-lg p-3 shadow-sm">
                <h3 className="font-semibold mb-1 opacity-80 text-sm">Budget</h3>
                <p className="font-medium">{job.budget}</p>
              </div>
              <div className="border border-base-300 rounded-lg p-3 shadow-sm">
                <h3 className="font-semibold mb-1 opacity-80 text-sm">Deadline</h3>
            ...
            <div className="mb-5">
              ...
              <div className="flex flex-wrap gap-2">
                {job.skills.map((skill, index) => (
                  <span key={index} className="badge badge-primary badge-md py-2 px-3 rounded-lg">
                    {skill}
                  </span>
                ))}
              </div>
            ...
            <div>
              ...
              <div className="opacity-90 whitespace-pre-line bg-base-200 p-4 rounded-lg text-sm">{job.jobDescription}</div>
            </div>
          </div>
        </div>
            ...
            {isApplied ? (
              <div className="alert bg-primary text-primary-content shadow-md rounded-lg">
                ...
                <div>
                  ...
                  <div className="text-xs">Your proposal has been sent to the employer.</div>
                </div>
              </div>
            ) : (
              <div className="space-y-5">
                ...
                <div className="form-control">
                  <label className="label pt-0">
                    <span className="label-text text-sm font-medium text-white">Your Proposal</span>
                  </label>
                  ...
                  <label className="label pb-0">
                    <span className="label-text-alt text-xs opacity-70 text-white">Provide details about your experience and approach</span>
                  </label>
                </div>
                ...
                <div className="form-control">
                  <label className="label pt-0">
                    <span className="label-text text-sm font-medium text-white">Your Charge</span>
                  </label>
                  <div className="mt-2 mb-2">
                    <input
                      type="text"
                  ...
                  <label className="label pb-0">
                    <span className="label-text-alt text-xs opacity-70 text-white">Specify your rate (hourly or fixed)</span>
                  </label>
                </div>
